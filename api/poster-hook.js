...
module.exports = async function hookPoster(env, items) {
  ...
  try {
    await fetch("https://api.github.com/repos/" + owner + "/" + repo + "/actions/workflows/backfill-posters.yml/dispatches", {
      method: "POST",
      headers: { Authorization: "Bearer " + env.GH_TOKEN, Accept: "application/vnd.github+json", "User-Agent": "dr-pinguin-tg-bot", "Content-Type": "application/json" },
