...
function pageHtml(opts) {
  ...
  return [
    ...
    ".acts a,.acts button{height:28px;flex:1;padding:0 8px;border-radius:6px;background:#272727;font-size:11px;font-weight:700;display:flex;align-items:center;justify-content:center}",
