...
module.exports = async function handler(req, res) {
  try {
    ...
    return send({ title: title, cat: cat, embed: embed, sourceWatch: sourceWatch, back: back, tall: !put && !mumu });
  } catch (e) {
    res.statusCode = 500;
    res.setHeader("Content-Type", "text/html; charset=utf-8");
